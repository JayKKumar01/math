...
public class mul extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMulBinding.inflate(getLayoutInflater());
...
//            v.setY(event.getRawY() + dy);
    ...
    public void gotoAdd(View view){
        Intent intent = new Intent(mul.this,MainActivity.class);
        startActivity(intent);
        finish();
    }
    public void gotoSub(View view){
        Intent intent = new Intent(mul.this,sub.class);
        startActivity(intent);
        finish();
    }
    public void gotoDiv(View view){
        Intent intent = new Intent(mul.this,div.class);
        startActivity(intent);
        finish();
    }
